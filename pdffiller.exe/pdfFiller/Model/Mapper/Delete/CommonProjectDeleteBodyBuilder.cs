...
// Type: pdfFiller.Model.Mapper.Delete.CommonProjectDeleteBodyBuilder
...
public class CommonProjectDeleteBodyBuilder : BaseProjectDeleteBodyBuilder
{
  public override Dictionary<string, object> Build(Project value)
  {
    ...
    dictionary["projects[0][isMultiExport]"] = (object) false;
    return dictionary;
  }

  protected override string GetDeleteType() => "DELETE_TYPE_COMMON";
}
